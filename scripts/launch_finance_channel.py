"""
Launch Finance Channel (currently named "AI Tools Daily") - First 4 videos
Using WanGP for generation, youtube_token_finance.json for upload
Content: Crypto, stocks, finance, money topics
"""
...
# Load storyboard
storyboard_path = Path("C:/Users/lijin/Projects/t2v-shorts-lab/storyboards/series_2026-02-17_finance.json")
data = json.loads(storyboard_path.read_text(encoding='utf-8'))

print("\n" + "="*70)
print("🚀 LAUNCHING FINANCE CHANNEL")
print("="*70)
print(f"Channel: Finance Channel (ID: UChmoxeUgszJP1_iC7nbce9Q)")
print(f"Token: youtube_token_finance.json")
print(f"Videos to create: {len(data['videos'])}")
print(f"Content: Crypto, stocks, finance, money")
print("="*70 + "\n")
...
for video_idx, video_data in enumerate(data["videos"], 1):
    ...
    # Combine scenes
    out_dir = Path("C:/Users/lijin/Projects/t2v-shorts-lab/out/finance")
    ...
    # Upload to Finance channel (using finance token)
    print(f"\n📤 Uploading to Finance Channel...")
    ...
    upload_result = subprocess.run([
        ...
        "--privacy", "public",
        "--channel", "finance"  # Use youtube_token_finance.json
...
print("\n" + "="*70)
print("🎉 FINANCE CHANNEL LAUNCHED!")
print("="*70)
...
print("Channel ID: UChmoxeUgszJP1_iC7nbce9Q")
print("="*70)
